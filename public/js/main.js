...
var _CategoryPackages = require('./CategoryPackages.vue');

var _CategoryPackages2 = _interopRequireDefault(_CategoryPackages);
...
exports.default = {
	...
	components: {
		...
		CategoryPackages: _CategoryPackages2.default
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n\t<li>\n\n\t\t<h6 class=\"category__title\" @click=\"visible = ! visible\">{{ category.name }}</h6>\n\n\t\t<category-packages v-show=\"visible\" :packages=\"category.packages\">\n\n\t\t</category-packages>\n\n\t</li>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
var _PackageLists = require('./components/PackageLists.vue');
